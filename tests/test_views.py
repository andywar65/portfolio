...
class ProjectViewsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(username="noviewer", password="P4s5W0r6")
        User.objects.create_user(username="viewer", password="P4s5W0r6")
        adder = User.objects.create_user(username="adder", password="P4s5W0r6")
