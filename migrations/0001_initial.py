    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('build', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='building_project', to='bimblog.building', verbose_name='Edificio')),
            ],
            options={
